...
const KYCRiskScoringReport = compose(withReportProvider)(
  /**
   *
   ...
   * @constructor
   */
  function KYCRiskScoringReport(props) {
    ...
    const header = {
      headerTitle: ["KYC", "RISK ASSESSMENT REPORT"],
          ...
          <Table declareColumnSizings={[4, 3, 3]} disableEvenOdd bordered>
            ...
            <TableRow evenOdd={"odd"} freeWeight>
              <TableCell style={localStyle.tableContentHorizontal}>
                {formatMessage({ id: "sanctioned-person-or-country" })}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {riskScoring.scoring.sanctionedPersonOrCountry.info |> toBool}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {sanction === true
                  ? "-"
                  : riskScoring.scoring.sanctionedPersonOrCountry.score}
              </TableCell>
            </TableRow>

            <TableRow evenOdd={"odd"} freeWeight>
              <TableCell style={localStyle.tableContentHorizontal}>
                {formatMessage({ id: "pep" })}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {riskScoring.scoring.pep.info > 0
                  ? `${formatMessage({ id: "tier" })} ${
                      riskScoring.scoring.pep.info
                    }`
                  : formatMessage({ id: "kyc.notPep" })}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {sanction === true ? "-" : riskScoring.scoring.pep.score}
              </TableCell>
            </TableRow>
            <TableRow evenOdd={"odd"} freeWeight>
              <TableCell style={localStyle.tableContentHorizontal}>
                {formatMessage({ id: "previous-sanctioned-person" })}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {riskScoring.scoring.previouslySanctionedPerson.info |> toBool}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {sanction === true
                  ? "-"
                  : riskScoring.scoring.previouslySanctionedPerson.score}
              </TableCell>
            </TableRow>
            <TableRow evenOdd={"odd"} freeWeight>
              <TableCell style={localStyle.tableContentHorizontal}>
                {formatMessage({ id: "finance-regulator" })}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {riskScoring.scoring.financialRegulator.info |> toBool}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {sanction === true
                  ? "-"
                  : riskScoring.scoring.financialRegulator.score}
              </TableCell>
            </TableRow>
            <TableRow evenOdd={"odd"} freeWeight>
              <TableCell style={localStyle.tableContentHorizontal}>
                {formatMessage({ id: "setting.tab.weight.lawEnforcement" })}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {riskScoring.scoring.lawEnforcement.info |> toBool}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {sanction === true
                  ? "-"
                  : riskScoring.scoring.lawEnforcement.score}
              </TableCell>
            </TableRow>
            <TableRow evenOdd={"odd"} freeWeight>
              <TableCell style={localStyle.tableContentHorizontal}>
                {formatMessage({ id: "setting.tab.weight.adverseMedia" })}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {riskScoring.scoring.adverseMedia.info |> toBool}
              </TableCell>
              <TableCell style={localStyle.tableContentHorizontal}>
                {sanction === true
                  ? "-"
                  : riskScoring.scoring.adverseMedia.score}
              </TableCell>
            </TableRow>
            ...
            <TableRow evenOdd={"old"} freeWeight>
              <TableCell style={localStyle.tableContentHorizontal}>
                {formatMessage({ id: "setting.tab.weight.CountryResidence" })}
              </TableCell>
            </TableRow>
            <TableRow evenOdd={"odd"} freeWeight>
              <TableCell style={localStyle.tableContentHorizontal}>
            ...
            <TableRow evenOdd={"odd"} freeWeight>
              ...
              <TableCell style={localStyle.tableContentHorizontal}>
                {sanction === true
                  ? "-"
                  : riskScoring.scoring.idIssuingCountry.fatf.score |> nullable}
              </TableCell>
            </TableRow>
            <TableRow evenOdd={"odd"} freeWeight>
              <TableCell style={localStyle.tableContentHorizontal}>
            ...
            <TableRow evenOdd={"odd"} freeWeight>
              ...
              <TableCell style={localStyle.tableContentHorizontal}>
                {sanction === true
                  ? "-"
                  : riskScoring.scoring.idIssuingCountry.cpi.score |> nullable}
              </TableCell>
            </TableRow>
            {/* nationality*/}
            <TableRow evenOdd={"odd"} freeWeight>
...
export default KYCRiskScoringReport;
