...
const KYCTableBusiness = compose(
  withStyles((them) => ({}), { name: "KYCTableBusiness" })
)(
        ...
        <Table>
          ...
          <TableBody>
            {data?.map((val) => {
              ...
              const riskLevel = get(val, "riskLevel");
              const numberOfChanges = get(val, "countRiskLevelChange");
                ...
                <TableRow>
                  <TableCell className={styles.wId}>
                    <div className={clsx(styles.Link, styles.Ids, "d-flex")}>
                      ...
                      >
                        <Link
                          to={`/app/screen-kyb/result/${val.kybId}${
                            val.status === "COMPLETED" ? "/riskAssessment" : ""
                          }`}
                          target={"_blank"}
                        >
                          {val?.kybId}
                  ...
                  <TableCell className={styles.wPercentOfShare}>
                    <TextField
                      ...
                      onChange={(e) =>
                        onChangeOfShare(e.target.value, val.kybId)
                      }
                    />
                  </TableCell>
                  ...
                  <TableCell className={styles.wPosition}>
                    ...
                    >
                      <TextField
                        ...
                        onChange={(e) =>
                          onChangeRemark(e.target.value, val.kybId, data)
                        }
                      />
                    </Tooltip>
                  </TableCell>
                  ...
                  <TableCell className={styles.width30}>
                    <div>
                      <span
                        ...
                        onClick={() => onPressRemove(val.kybId)}
                      >
                        <RemoveIcon />
                      </span>
                    </div>
...
export default KYCTableBusiness;
