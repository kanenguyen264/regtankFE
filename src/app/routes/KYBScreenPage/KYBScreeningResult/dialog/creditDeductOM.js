...
const OnGoingMonitoringDialog = ({ onClose, selected, enableOM }) => {
  ...
  const { omStartPeriod, omEndPeriod, kybId } = currentScreeningResult;
  ...
  const handleSave = async () => {
    ...
    if (dontShowAgain) {
      ...
      summitedData.kybOmDeductionConfirmation = false;
    ...
    await dispatch(KYB_ACTION_GET_KYB_REQUEST(kybId));
    setLoading(false);
