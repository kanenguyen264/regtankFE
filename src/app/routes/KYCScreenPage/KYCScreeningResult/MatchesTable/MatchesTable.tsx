...
import KYCScreeningResultFilter from "../KYCScreeningResultFilter";
...
const MatchesTable = (props: MatchesTableProps & EnhancedFilterProps) => {
  ...
  const filterList = useSelector((state) => state.kyc.currentMatchesFilterList);
  ...
  const LeftButtons = (useCallback(() => {
    const falseButton = ACL.isAllowedPermissions("KYC_STATUS_RESOLUTION") ? (
      <Button
    ...
    const positiveButton = ACL.isAllowedPermissions("KYC_STATUS_RESOLUTION") ? (
      <Button
    ...
    if (selected.length === 1) {
      return [
        <ExportCSV
          ...
          className={clsx("mr-3", styles.exportCsv)}
    ...
    <div className={styles.searchResultTable}>
      ...
      <div>
        ...
        {/* <FilterComponent
          ...
          classes={{
            selectType: clsx(
              styles.filterSelectPopover,
              // moduleStyles.actionsPopover
            ),
            datePicker: styles.filterDatePicker,
          }}
        /> */}
      </div>
