...
import { ReactComponent as IcAddGroupList } from "assets/icons/IcAddGroupList.svg";
import { ReactComponent as IcArchive } from "assets/icons/IcArchive.svg";
...
import { ReactComponent as RejectIcon } from "assets/icons/IcRejected.svg";
import { ReactComponent as IcRemoveGroupList } from "assets/icons/IcRemoveGroupList.svg";
...
import { ReactComponent as IcUnarchive } from "assets/icons/IcUnarchive.svg";
...
import { getEventTypeLiveness, getLabelViewLog } from "util/viewLog";
...
const getIconViewLog = (type) => {
  switch (type) {
    ...
    case ADD: {
      return <IcAddGroupList />;
    }
    case REMOVE: {
      return <IcRemoveGroupList />;
    }
    default:
      return "";
  }
    ...
    <>
          ...
          <div className={clsx(styles.gridItem, "d-flex align-items-center")}>
            ...
            <Nullable>
              <span className={styles.text}>
                {getEventTypeLiveness(data?.eventType) && (
                  <IntlMessages id={getEventTypeLiveness(data?.eventType)} />
                )}
              </span>
            </Nullable>
          </div>
      ...
      <Grid item xs={4}>
        <div className={"d-flex flex-column"}>
          ...
          <div className={clsx(styles.gridItem, "d-flex align-items-center ")}>
            <Nullable>
              <span className={styles.text}>{getNameUserAction(data)}</span>
            </Nullable>
          </div>
        </div>
      </Grid>
            ...
            >
              <div className={styles.dialogContent}>
                ...
                {activityLogCurrent?.map((item, index) => {
                  return (
                    <Grid container key={index} className={styles.itemContent}>
                      <Content
                        data={item}
