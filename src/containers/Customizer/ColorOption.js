            ...
            <ul className="color-option">
              <li>
                <span
                  ...
                  className={`jr-link bg-indigo ${
                    themeColor === INDIGO && "active"
                  }`}
                />
              </li>
              <li>
                <span
                  ...
                  className={`jr-link bg-cyan ${
                    themeColor === CYAN && "active"
                  }`}
                />
              </li>
              <li>
                <span
                  ...
                  className={`jr-link bg-amber ${
                    themeColor === AMBER && "active"
                  }`}
                />
              </li>
              <li>
                <span
                  ...
                  className={`jr-link bg-deep-orange ${
              ...
              <li>
                <span
                  ...
                  className={`jr-link bg-pink ${
                    themeColor === PINK && "active"
                  }`}
                />
              </li>
              <li>
              ...
              <li>
                <span
                  ...
                  className={`jr-link bg-deep-purple ${
                    themeColor === DEEP_PURPLE && "active"
                  }`}
                />
              </li>
              <li>
                <span
                  ...
                  className={`jr-link bg-green ${
                    themeColor === GREEN && "active"
                  }`}
                />
              </li>
            </ul>
            ...
            <ul className="color-option cr-op-dark-sidebar">
              ...
              <li>
                <span
                  ...
                  className={`jr-link bg-deep-orange ${
                    themeColor === DARK_DEEP_ORANGE && "active"
                  }`}
                />
              </li>
              ...
              <li>
                <span
                  ...
                  className={`jr-link bg-deep-purple ${
                    themeColor === DARK_DEEP_PURPLE && "active"
                  }`}
                />
              </li>
              <li>
